...
namespace aSnapshot
{
    ...
    inline function loadVoiceShot(obj,v)
    {
        ...
        Console.print("loading voice:" + v);
        Console.print("current snap is:" + currentSnap);
...
inline function setFilter(voice,type)
{
    ...
    {
        case 1:
            TheS1Filters[voice].setAttribute(TheS1Filters[voice].Mode, mode);
            break;
        case 2:
            TheS2Filters[voice].setAttribute(TheS2Filters[voice].Mode, mode);
            break;
        case 3:
            TheS3Filters[voice].setAttribute(TheS3Filters[voice].Mode, mode);
            break;
    };
...
inline function setIRs(voice,irnum)
{
  ...
  {
     case 1:
            irname = "{PROJECT_FOLDER}BathRoom 1_5 Seconds.wav";
            break;
     case 2:
            irname = "{PROJECT_FOLDER}BathRoom 2_5 Seconds.wav";
            break;
     case 3:
            irname = "{PROJECT_FOLDER}BathRoom 3_5 Seconds.wav";
            break;
     case 4:
            irname = "{PROJECT_FOLDER}Factory 1_5 Seconds.wav";
            break;
     case 5:
            irname = "{PROJECT_FOLDER}Factory 2_5 Seconds.wav";
            break;
     case 6:
            irname = "{PROJECT_FOLDER}Factory 3_5 Seconds.wav";
            break;
     case 7:
            irname = "{PROJECT_FOLDER}Room 0_4 Seconds.wav";
            break;
     case 8:
            irname = "{PROJECT_FOLDER}Room 1_5 Seconds.wav";
            break;
     case 9:
            irname = "{PROJECT_FOLDER}Room 2_5 Seconds.wav";
            break;
     case 10:
            irname = "{PROJECT_FOLDER}Room 3_5 Seconds.wav";
            break;
     case 11:
            irname = "{PROJECT_FOLDER}Room 4_4 Seconds.wav";
            break;
     case 12:
            irname = "{PROJECT_FOLDER}Room 5_5 Seconds.wav";
            break;
     case 13:
            irname = "{PROJECT_FOLDER}Room 6_5 Seconds.wav";
            break;
    };
    ...
    {
        case 1:
            TheS1Reverbs[voice].setFile(irname);
            break;
        case 2:
            TheS2Reverbs[voice].setFile(irname);
            break;
        case 3:
            TheS3Reverbs[voice].setFile(irname);
            break;
    };
};
...
for (idx = 0; idx < NUM_VOICES; idx++)
{
    ...
    TheS1Filters[idx] = Synth.getEffect("S1Filter" + (idx+1));
    TheS2Filters[idx] = Synth.getEffect("S2Filter" + (idx+1));
    TheS3Filters[idx] = Synth.getEffect("S3Filter" + (idx+1));
    ...
    TheS1Reverbs[idx] = Synth.getAudioSampleProcessor("S1Convolution Reverb" + (idx+1));
    TheS2Reverbs[idx] = Synth.getAudioSampleProcessor("S2Convolution Reverb" + (idx+1));
    TheS3Reverbs[idx] = Synth.getAudioSampleProcessor("S3Convolution Reverb" + (idx+1));
...
const var FilterDisplay1 = Content.getComponent("FilterDisplay1");
const var FilterDisplay2 = Content.getComponent("FilterDisplay2");
const var FilterDisplay3 = Content.getComponent("FilterDisplay3");
...
inline function onSnapshot1OnOffControl(component, value)
{
	...
	if (value)
    {
       ...
       if (typeof SnapShotSet == "object")
        {
            // turn off the snap 2 & 3 filters & reverb
            for (sdx= 0; sdx < 3; sdx++)
            {
               TheS2Filters[sdx].setBypassed(true);
               TheS3Filters[sdx].setBypassed(true);
               TheS2Reverbs[sdx].setBypassed(true);
               TheS3Reverbs[sdx].setBypassed(true);
            }
            // load snapshot 1 into the instrument
            currentSnap = 1;
            local mySnap = SnapShotSet.snap1;
            aSnapshot.loadASnapshot(mySnap);
            // display the correct S1 values
            FilterDisplay1.set("Data","{\r\n  \"ProcessorId\": \"S1Filter1\",\r\n  \"Index\": -1\r\n}");
            FilterDisplay2.set("Data","{\r\n  \"ProcessorId\": \"S1Filter2\",\r\n  \"Index\": -1\r\n}");
            FilterDisplay3.set("Data","{\r\n  \"ProcessorId\": \"S1Filter3\",\r\n  \"Index\": -1\r\n}");
...
inline function onSnapshotOnOff2Control(component, value)
{
	...
	if (value)
    {
       ...
       if (typeof SnapShotSet == "object")
        {
            // turn off the snap 1 & 3 filters & reverb
            for (sdx= 0; sdx < 3; sdx++)
            {
               TheS1Filters[sdx].setBypassed(true);
               TheS3Filters[sdx].setBypassed(true);
               TheS1Reverbs[sdx].setBypassed(true);
               TheS3Reverbs[sdx].setBypassed(true);
            }
            ...
            // display the correct S2 values
            FilterDisplay1.set("Data","{\r\n  \"ProcessorId\": \"S2Filter1\",\r\n  \"Index\": -1\r\n}");
            FilterDisplay2.set("Data","{\r\n  \"ProcessorId\": \"S2Filter2\",\r\n  \"Index\": -1\r\n}");
            FilterDisplay3.set("Data","{\r\n  \"ProcessorId\": \"S2Filter3\",\r\n  \"Index\": -1\r\n}");
...
inline function onSnapshotOnOff3Control(component, value)
{
	...
	if (value)
    {
       ...
       if (typeof SnapShotSet == "object")
        {
            // turn off the snap 1 & 2 filters & reverb
            for (sdx= 0; sdx < 3; sdx++)
            {
               TheS1Filters[sdx].setBypassed(true);
               TheS2Filters[sdx].setBypassed(true);
            ...
            // display the correct S3 values
            FilterDisplay1.set("Data","{\r\n  \"ProcessorId\": \"S3Filter1\",\r\n  \"Index\": -1\r\n}");
            FilterDisplay2.set("Data","{\r\n  \"ProcessorId\": \"S3Filter2\",\r\n  \"Index\": -1\r\n}");
            FilterDisplay3.set("Data","{\r\n  \"ProcessorId\": \"S3Filter3\",\r\n  \"Index\": -1\r\n}");
...
inline function onFilterOnOff(component, value)
{
    ...
    for (i=0;i < NUM_VOICES;i++)
    {
        if (locSet == 1)  // yep so set everyone...
        {
            ...
            {
                case 1:
                    TheS1Filters[i].setBypassed(1 - value);
                    break;
                case 2:
                    TheS2Filters[i].setBypassed(1 - value);
                    break;
                case 3:
                    TheS3Filters[i].setBypassed(1 - value);
                    break;
            };
...
inline function onFreqKnob(component, value)
{
    ...
    for (i=0;i < NUM_VOICES;i++)
    {
        if (locSet == 1)  // yep so set everyone...
        {
            ...
            {
                case 1:
                    TheS1Filters[i].setAttribute(TheS1Filters[i].Frequency,value);
                    break;
                case 2:
                    TheS2Filters[i].setAttribute(TheS2Filters[i].Frequency,value);
                    break;
                case 3:
                    TheS3Filters[i].setAttribute(TheS3Filters[i].Frequency,value);
                    break;
            };
...
inline function onResKnob(component, value)
{
    ...
    for (i=0;i < NUM_VOICES;i++)
    {
        if (locSet == 1)  // yep so set everyone...
        {
            ...
            {
                case 1:
                    TheS1Filters[i].setAttribute(TheS1Filters[i].Q,value);
                    break;
                case 2:
                    TheS2Filters[i].setAttribute(TheS2Filters[i].Q,value);
                    break;
                case 3:
                    TheS3Filters[i].setAttribute(TheS3Filters[i].Q,value);
                    break;
            };
...
inline function onReverbOnOff(component, value)
{
    ...
    for (i=0;i < NUM_VOICES;i++)
    {
        if (locSet == 1)  // yep so set everyone...
        {
            ...
            {
                case 1:
                    TheS1Reverbs[i].setBypassed(1 - value);
                    break;
                case 2:
                    TheS2Reverbs[i].setBypassed(1 - value);
                    break;
                case 3:
                    TheS3Reverbs[i].setBypassed(1 - value);
                    break;
            };
...
inline function onReverbWet(component, value)
{
    ...
    for (i=0;i < NUM_VOICES;i++)
    {
        if (locSet == 1)  // yep so set everyone...
        {
            ...
            {
                case 1:
                    TheS1Reverbs[i].setAttribute(TheS1Reverbs[i].WetGain, value);
                    break;
                case 2:
                    TheS2Reverbs[i].setAttribute(Thes2Reverbs[i].WetGain, value);
                    break;
                case 3:
                    TheS3Reverbs[i].setAttribute(TheS3Reverbs[i].WetGain, value);
                    break;
            };
...
inline function onReverbDry(component, value)
{
    ...
    for (i=0;i < NUM_VOICES;i++)
    {
        if (locSet == 1)  // yep so set everyone...
        {
            ...
            {
                case 1:
                    TheS1Reverbs[i].setAttribute(TheS1Reverbs[i].DryGain, value);
                    break;
                case 2:
                    TheS2Reverbs[i].setAttribute(Thes2Reverbs[i].DryGain, value);
                    break;
                case 3:
                    TheS3Reverbs[i].setAttribute(TheS3Reverbs[i].DryGain, value);
                    break;
            };
...
{
    // extract the trigger note values
    local myText = component.getItemText();
    
    MIDINoteTarget1 = myText.substring(0,2);
    MIDINoteTarget2 = myText.substring(3,5);
    MIDINoteTarget3 = myText.substring(6,8);
    paintKeys();
};
...
{   
    ...
    {
        //not a valid set up trigger note - so ignore it
        Message.ignoreEvent(true);
    }else{
    
        // a valid set up trigger note - do we need to swap around the snapshot?
        if (Message.getNoteNumber() == MIDINoteTarget1 && currentSnap != 1)
        {
            Snapshot1OnOff.setValue(1);
            Snapshot1OnOff.changed();
            SnapshotOnOff2.setValue(0);
            ...
            //wait for the param changes to happen..
            Message.delayEvent(2500);
            currentSnap = 1;
        }
        if (Message.getNoteNumber() == MIDINoteTarget2 && currentSnap != 2)
        {
        ...
        if (Message.getNoteNumber() == MIDINoteTarget3 && currentSnap != 3)
        {
        ...
        // its a valid request and we've changed the snap if required so play the source note
